  ...
  return (
    <MainContainer title="Płatności">
      <div className="grid grid-cols-6 grid-rows-2 gap-10">
        <div className="col-span-6 flex  flex-col gap-3  border-2 border-slate-900 bg-slate-900 px-4 pt-4 shadow-2xl shadow-slate-900 ">
        ...
        <div className="col-span-4 flex flex-col gap-3  bg-slate-900  px-2 pt-4   shadow-2xl shadow-slate-900 ">
