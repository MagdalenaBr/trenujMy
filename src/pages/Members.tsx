		...
		<MainContainer title='Klienci'>
			<div className='flex justify-between items-center '>
				<div className='relative'>
					...
					<input className='border-2 w-80 bg-slate-100 rounded-lg pl-8 pr-2 py-1 focus:border-cyan-800  focus:bg-sky-100 focus:outline-none transition-colors focus:shadow-md' />
				</div>
