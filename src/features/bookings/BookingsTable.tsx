...
function BookingsTable() {
  ...
  if (!bookings?.length)
    return <TableNoContent>Brak danych dotyczących rezerwacji.</TableNoContent>;
  ...
  return (
    <Table
      uniqueStyles="px-2 py-2 w-[40rem]  lg:w-auto"
      columns="lg:grid-cols-4"
      smColumns="grid-cols-[150px_160px_100px_200px]"
    >
      <Table.Header>
        <p>Klient</p>
        <p>Trener</p>
