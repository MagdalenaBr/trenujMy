    ...
    <div className="mb-4 flex items-center justify-between">
      <div className="relative focus:text-slate-700">
        ...
        <input
          ...
          className="w-80 rounded-lg border-2 border-violet-300 bg-serchInputBg  py-1 pl-8 pr-2 focus:border-slate-300 focus:bg-slate-300 focus:text-slate-800 focus:shadow-md focus:outline-none"
        />
      </div>
    </div>
  );
