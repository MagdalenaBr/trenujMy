...
function AppLayout() {
  ...
  return (
    ...
    >
      ...
      <div
        className={`${navigationVisibility === "hidden" ? "fixed translate-x-[-100%]" : " absolute bottom-0 left-0 right-0 top-auto z-10 overflow-hidden  bg-slate-900"}  font-semibold lg:relative lg:translate-x-0`}
      >
        <Logo />
